...
<TABLE cellspacing="0" cellpadding="0" border="0" width="100%"
	...
	<TR valign="top">
		...
		<TD valign="top" width="100%" height="100%"><html:form
			action="/LoginAction" onsubmit="javascript:return doValidate()">
			<TABLE width="545" border="0" cellpadding="5" cellspacing="0"
				...
				<TR>
					<TD align="left" class="txt" colspan="4"></TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD><html:password property="password" size="19"
						styleClass="box" redisplay="false" /></TD>
					<TD width="121" class="text">&nbsp;</TD>
					<TD width="171">&nbsp;</TD>
				</TR>
				<TR>
				...
				<TR>
					<TD colspan="2" align="center"><FONT color="RED"><STRONG><html:errors
