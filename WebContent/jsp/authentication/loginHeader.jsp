...
<table border="0" cellpadding="0" cellspacing="1" bgcolor="#000000" width="100%" valign="top">
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="64" align="left" valign="top" background="<%=request.getContextPath()%>/images/t_bg.gif"><h1><font color="Black" style="bold" size="100">Project Ascients</font></h1></td>
  </tr>
</TABLE>
</BODY>
</HTML>
