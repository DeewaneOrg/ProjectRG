	...
	function fCheckVal(Obj,ObjName,Label,str)
	{
		...
		*/
		...
		if(str=="10")
		{
			 ...
			 {
				alert(Label + " field can have numeric values of length less then ten");
				strExp1 = "document.forms[0]."+ObjName+".select()";
				eval(strExp1);
				strExp = "document.forms[0]."+ObjName+".focus()";
				eval(strExp);
		...
		if(str=="15")
		{
			 ...
			 {
				alert(Label + " field can only have integer value less then and equal to 12");
				strExp1 = "document.forms[0]."+ObjName+".select()";
				eval(strExp1);
				strExp = "document.forms[0]."+ObjName+".focus()";
				eval(strExp);
		...
		if(str=="18")
		{
			 ...
			 {
				alert(Label + " field can only have integer values less then and equal to 3000");
				strExp1 = "document.forms[0]."+ObjName+".select()";
				eval(strExp1);
				strExp = "document.forms[0]."+ObjName+".focus()";
				eval(strExp);
